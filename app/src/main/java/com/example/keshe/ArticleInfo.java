...
public class ArticleInfo {
    private static final String[] articleIDArray = {"1", "2", "3", "4", "5", "6"};
    private static final String[] titleArray = {"二十四节气之白露", "二十四节气之处暑", "二十四节气之立秋", "二十四节气之大暑", "二十四节气之小暑", "二十四节气之冬至"};
    private static final String[] contentArray = {"白露，是“二十四节气”中的第15个节气，秋季第3个节气，干支历申月的结束与酉月的起始。斗指癸；太阳达黄经165度；于公历9月7-9日交节。“白露”是反映自然界寒气增长的重要节气。由于冷空气转守为攻，白昼有阳光尚热，但傍晚后气温便很快下降，昼夜温差逐渐拉大。",
    ...
    private static final int[] articlePicArray = {R.drawable.bailu, R.drawable.chushu, R.drawable.liqiu, R.drawable.dashu, R.drawable.xiaoshu, R.drawable.dongzhi};
    private static final String[] authorArray = {"zxx", "ltb", "cjl", "zxx", "ltb", "cjl"};
